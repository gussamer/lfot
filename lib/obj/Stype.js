          ...
          this.stypes.forEach(sfolder => {
            ...
            sfolder.getSmembers(() => {
              ...
              if(!this.sfolderNamesToList.length) {
                this.log.it('[+] listing ' + this.name + 'Folder ' + ' complete')
                callback(this)
              } else {
                this.log.it('[!] still ' + this.sfolderNamesToList.length + ' to go')
              }
            })
          })
        }
